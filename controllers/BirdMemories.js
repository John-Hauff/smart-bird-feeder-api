...
const postBirdMemory = (req, res) => {
  ...
  // parse `originalname` file from request to get the species name and the datetime of memory creation
  let species_name = req.file.originalname.split("/")[0];
  console.log(req.file);
  new_img.img.data = fs.readFileSync(req.file.path);
  new_img.img.contentType = "image/jpeg";
  new_img.img.species = species_name;
...
module.exports = { postBirdMemory, getBirdMemory, postNotification };
